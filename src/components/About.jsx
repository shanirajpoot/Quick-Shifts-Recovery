  ...
  return (
    <div>
      ...
      <head>
        ...
        <title>About Us - Quick Shift Recovery</title>
        <meta
          name="description"
          content="Quick Shift Recovery offers reliable 24/7 emergency towing and recovery services. Our professional team ensures quick response, fair pricing, and friendly service."
        />
        <meta
          name="keywords"
          content="vehicle towing, roadside assistance, 24/7 emergency recovery, flat tire, car breakdown recovery, car recovery services, towing company"
        />
        <meta property="og:title" content="About Us - Quick Shift Recovery" />
        <meta
          property="og:description"
          content="Quick Shift Recovery provides efficient and reliable vehicle towing services. We offer emergency roadside assistance with quick response times and affordable pricing."
        />
        <meta
          property="og:image"
          content="https://example.com/images/about-us-image.jpg" // Replace with actual image URL
        />
        <meta property="og:url" content="https://example.com/about" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About Us - Quick Shift Recovery" />
        <meta
          name="twitter:description"
          content="Reliable 24/7 towing and vehicle recovery services with fast response times. Choose Quick Shift Recovery for your emergency towing needs."
        />
        <meta
          name="twitter:image"
          content="https://example.com/images/about-us-image.jpg" // Replace with actual image URL
